...
import mainBodyBackground from 'assets/mainBodyBackground.png'

function MainBody() {
  return (
    <div className="top-10 h-full w-full bg-MainBodyColor1/5 z-0">
      <div className="flex">
        <div className="flex-1 w-90 h-full ml-36 mt-64 z-10">
          <div className="h-20">
        ...
        >
          ...
          <img src={mainBodyBackground} className='z-[-1] w-4/5'></img>
